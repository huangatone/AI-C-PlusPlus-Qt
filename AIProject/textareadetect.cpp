...
const string IMAGEPATH = "/rong/tmp/demo.jpeg";//图像路径
...
Mat TextAreaDetect::preprocess(Mat gray)
{
	...
	//7.存储中间图片
	imwrite("/rong/tmp/dbinary.jpg", binary);
	imwrite("/rong/tmp/ddilate1.jpg", dilate1);
	imwrite("/rong/tmp/derode1.jpg", erode1);
	imwrite("/rong/tmp/ddilate2.jpg", dilate2);
